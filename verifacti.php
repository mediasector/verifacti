...
// Migración de opciones antiguas si existen
$legacyKey = 'verifacti_setting';
$newKey = VERIFACTI_MODULE_NAME.'_setting';
if(get_option($legacyKey) && !get_option($newKey)){
    update_option($newKey, get_option($legacyKey));
}
